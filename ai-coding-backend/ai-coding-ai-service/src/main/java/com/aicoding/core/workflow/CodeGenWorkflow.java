...
public class CodeGenWorkflow {
    ...
    private com.aicoding.api.AppRpcService appRpcService;
    ...
    private Map<String, Object> finalizeNode(WFState state) throws Exception {
        ...
        // 版本时光机：本次产物自动快照（RPC 到 app-service，读取共享工作区）
        int version = appRpcService.createVersionSnapshot(state.appId(), state.userId(), abbreviate(message, 60), state.genType());
